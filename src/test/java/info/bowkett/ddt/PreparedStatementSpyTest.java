...
public class PreparedStatementSpyTest {
  ...
  @Test
  public void testExecuteLargeBatchIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().executeLargeBatch();
    then(pstmt, once()).executeLargeBatch();
  }

  @Test
  public void testExecuteLargeUpdateIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().executeLargeUpdate();
    then(pstmt, once()).executeLargeUpdate();
  }

  @Test
  public void testExecuteLargeUpdateWithSQLIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().executeLargeUpdate("SOME SQL");
    then(pstmt, once()).executeLargeUpdate("SOME SQL");
  }

  @Test
  public void testExecuteLargeUpdateWithSQLAndAutoGeneratedKeysIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().executeLargeUpdate("SOME SQL", Statement.RETURN_GENERATED_KEYS);
    then(pstmt, once()).executeLargeUpdate("SOME SQL", Statement.RETURN_GENERATED_KEYS);
  }

  @Test
  public void testExecuteLargeUpdateWithSQLAndColumnIndexesIsCalledOnDelegate() throws Exception {
    final int[] columnIndexes = new int[]{4,5};
    given_aPlainStatement().executeLargeUpdate("SOME SQL", columnIndexes);
    then(pstmt, once()).executeLargeUpdate("SOME SQL", columnIndexes);
  }

  @Test
  public void testExecuteLargeUpdateWithSQLAndColumnNamesIsCalledOnDelegate() throws Exception {
    final String [] columnIndexes = new String[]{"column_1", "column_2"};
    given_aPlainStatement().executeLargeUpdate("SOME SQL", columnIndexes);
    then(pstmt, once()).executeLargeUpdate("SOME SQL", columnIndexes);
  }
  ...
  @Test
  public void testGetLargeMaxRowsIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().getLargeMaxRows();
    then(pstmt, once()).getLargeMaxRows();
  }

  @Test
  public void testGetLargeUpdateCountIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().getLargeUpdateCount();
    then(pstmt, once()).getLargeUpdateCount();
  }
  ...
  @Test
  public void testSetLargeMaxRowsIsCalledOnDelegate() throws Exception {
    given_aPlainStatement().setLargeMaxRows(0);
    then(pstmt, once()).setLargeMaxRows(0);
  }
  ...
  @Test
  public void testSetObjectWithSQLTypeAndScaleIsCalledOnDelegate() throws Exception {
    final Object mock = mock(Object.class);
    given_aPlainStatement().setObject(1, mock, JDBCType.VARCHAR, 1024);
    then(pstmt, once()).setObject(1, mock, JDBCType.VARCHAR, 1024);
  }

  @Test
  public void testSetObjectWithSQLTypeAndScaleIsSetInSQLByCallingToStringOnTheObject() throws Exception {
    final Object mock = mock(Object.class);
    when(mock.toString()).thenReturn("Some string rep");
    given_aPlainStatement().setObject(1, mock, JDBCType.VARCHAR, 1024);
    then_theFormattedSQLIs("INSERT INTO some_table(column_1) VALUES ('Some string rep')");
  ...
  @Test
  public void testSetObjectWithSQLTypeIsCalledOnDelegate() throws Exception {
    final Object mock = mock(Object.class);
    given_aPlainStatement().setObject(1, mock, JDBCType.VARCHAR);
    then(pstmt, once()).setObject(1, mock, JDBCType.VARCHAR);
  }

  @Test
  public void testSetObjectWithSQLTypeIsSetInSQLByCallingToStringOnTheObject() throws Exception {
    final Object mock = mock(Object.class);
    when(mock.toString()).thenReturn("Some string rep");
    given_aPlainStatement().setObject(1, mock, JDBCType.VARCHAR);
    then_theFormattedSQLIs("INSERT INTO some_table(column_1) VALUES ('Some string rep')");
  ...
  public void printMethodNames() throws SQLException {
    ...
    final Stream<String> methodNames = Arrays.stream(methods).map(Method::getName);
    methodNames.sorted().distinct().forEach(originalName -> {
